...
const Pesquisa = () => {
    ...
    return (
        <div className="pt-6">
            ...
            {sucess && <div className="w-1/5 mx-auto">
                <p className="mb-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3">Obrigado por contribuir com sua sugetão ou crítica.</p>
                {
